function PointJS(hc, da, ea, xa, vc) {
    ...
    var h = window, u = this, ya = !0, cb = !0, zb = !1, ha = !1, Ka = !0, r = da, t = ea, O = r / 2, P = t / 2,
        f = {x: 0, y: 0},
        v = {fillStyle: "black", strokeStyle: "black", globalAlpha: 1, font: "sans-serif", textBaseline: "top"},
        D = function (a) {
    ...
    var Cb = "", Db = "", Eb = function (a, b) {
        ...
        w.style.backgroundColor = xa.backgroundColor ? xa.backgroundColor :
            "black";
        n.attach(w);
    ...
    var e = function (a, b) {
        ...
        var c = 0, d = b.length - 1, k = b[d].y < a.y, e, f;
        e = 0;
        for (f = b.length; e < f; ++e) {
            var g = b[e].y < a.y, d = ib(b[d], a), h = ib(b[e], a), d = d.x * (h.y - d.y) -
                d.y * (h.x - d.x);
            g && !k && 0 < d && (c += 1);
            !g && k && 0 > d && (c += 1);
            d = e;
    ...
    var lc = 0, n = {
        ...
        addEvent: function (a, b, c) {
            "onload" == a && n.loaded ? c() : n.events[a].push({id: b, func: c})
        },
    ...
    m.style.backgroundColor =
        "black";
    if ("object" == typeof xa) for (var kb in xa) kb.match(/margin|padding|position/) || (m.style[kb] = xa[kb]);
    n.addEvent("onload", "Window_Hide_Scroll", function () {
        h.document.body.style.overflow = "hidden";
        lb = {x: parseInt(m.style.left), y: parseInt(m.style.top)}
    });
    var lb = e(0, 0), g = null, l = null, aa = !1, g = m.getContext("2d");
    "GL2D" == hc ? (jc(), Db = "attribute vec2 aPosition; attribute vec2 aTextCoord; uniform vec2 uResolution; uniform int uMirrorX; varying vec2 vTextureCoord; void main() {    vec2 zeroToOne = aPosition / uResolution;    vec2 zeroToTwo = zeroToOne * 2.0;    vec2 clipSpace = zeroToTwo - 1.0;    gl_Position = vec4(clipSpace * vec2((uMirrorX == 1 ? -1 : 1), -1), 0, 1);    vTextureCoord = aTextCoord; }",
        Cb = "precision mediump float; uniform sampler2D texture; varying vec2 vTextureCoord; uniform int uInversion; void main() { \tvec4 texColor = texture2D(texture,vTextureCoord.xy); \tvec4 finalColor; \tfinalColor = texColor; \tif (uInversion == 1) \t\tfinalColor = 1.0 - finalColor; \tgl_FragColor = finalColor; }", T = l.createProgram(), l.attachShader(T, Eb(l.VERTEX_SHADER, Db)), l.attachShader(T, Eb(l.FRAGMENT_SHADER, Cb)), l.linkProgram(T), l.getProgramParameter(T, l.LINK_STATUS) || D("Can't install shader"), l.useProgram(T),
        kc(), aa = !0, n.addEvent("postLoop", "drawGL", function () {
    ...
    this.system.resize = function (a, b) {
        ...
        m.height = t;
        aa && (w.width =
            m.width, w.height = m.height, l.viewport(0, 0, r, t))
    };
    ...
    var U = !1, mc = function () {
        U || (this.requestFullscreen ? (this.requestFullscreen(), U = !0) : this.mozRequestFullScreen ? (this.mozRequestFullScreen(), U = !0) : this.webkitRequestFullscreen &&
            (this.webkitRequestFullscreen(), U = !0), r = n.getWH().w, t = n.getWH().h, O = r / 2, P = t / 2, m.width = r, m.height = t, aa && (w.width = m.width, w.height = m.height, l.viewport(0, 0, r, t)))
    }, mb = function (a) {
    ...
    this.system.initFullScreen = function () {
        U || (h.document.documentElement.onclick =
            mc, Ba || (n.addEvent("gameResize", "PointJS_initFullScreen", function () {
            r = n.getWH().w;
            t = n.getWH().h;
            O = r / 2;
            P = t / 2;
    ...
    this.system.exitFullScreen = function () {
        U && (n.delEvent("gameResize", "PointJS_initFullScreen"), h.document.exitFullscreen ? (h.document.exitFullscreen(), U = !1) : h.document.mozCancelFullScreen ? (h.document.mozCancelFullScreen(), U = !1) : h.document.webkitExitFullscreen &&
            (h.document.webkitExitFullscreen(), U = !1), r = da, t = ea, O = r / 2, P = t / 2, m.width = r, m.height = t, aa && (w.width = m.width, w.height = m.height, l.viewport(0, 0, r, t)), h.document.documentElement.onclick = function () {
        })
    };
    ...
    var W = !1, Ba = !1, Ib = da, Jb = ea, Kb = !1;
    this.system.initFullScale = function (a) {
        Ba || (a && (Kb = !0), n.addEvent("gameResize", "PointJS_initFullScale",
            function () {
                var a = Ib, c = Jb, d = n.getWH();
    ...
    this.system.exitFullScale = function () {
        Ba && (Ba = !1, n.delEvent("gameResize", "PointJS_initFullScale"), m.style.width = da + "px", m.style.height = ea + "px", aa && (w.style.width = m.style.width, w.style.height =
            m.style.height, l.viewport(0, 0, r, t)))
    };
    this.system.getWH = function () {
        return n.getWH()
    };
    var nc = [], oc = 0, ra = function (a, b) {
    ...
    ra.prototype = {
        onEvents: function (a) {
            "function" == typeof a.keyPress && (this.el.onkeypress = function (b) {
                b.stopPropagation();
                var c = !1;
                0 != b.which && 0 != b.charCode &&
                32 <= b.which && (c = String.fromCharCode(b.which));
                return a.keyPress(c)
            });
            ...
            "function" == typeof a.mousePress && (this.el.onmousedown =
                function (b) {
                    b.stopPropagation();
                    a.mousePress()
                });
            ...
            return e(parseInt(this.el.style.left),
    ...
    this.actionControl.isPress = function () {
        return E ? u.touchControl.isPress() :
            u.mouseControl.isPress("LEFT")
    };
    ...
    this.actionControl.isInDynamic = function (a) {
        return E ? u.touchControl.isInDynamic(a) :
            u.mouseControl.isInDynamic(a)
    };
    ...
    var sa = {}, Ca = {}, ja = {}, Da = !1, Ea = !1, Na = !1, rc = function (a) {
    ...
    var F = e(0, 0), Oa = e(0, 0);
    e(0, 0);
    var Fa = !0, nb = "", Pa = !1, la = e(0, 0), Qa = !1, ob = {LEFT: 1, RIGHT: 3, MIDDLE: 2}, Ra = {}, Sa = {},
        Ga = {}, Ha = 0, Lb = function () {
            Ra = {};
            Sa = {};
            Ga = {};
    ...
    this.mouseControl.initMouseLock = function () {
        n.addEvent("onload", "initPointerLock", function () {
            ...
            "onpointerlockchange" in h.document ? h.document.addEventListener("pointerlockchange",
                Nb, !1) : "onmozpointerlockchange" in h.document && h.document.addEventListener("mozpointerlockchange", Nb, !1);
    ...
    this.mouseControl.initMouseControl = function () {
        ...
        h.oncontextmenu = h.onselectstart =
    ...
    var Va = !1, Wa = 0, Xa = 0, H = 0, I = 0, y = e(0, 0), Ia = e(0, 0), Ya = e(0, 0);
    ...
    this.touchControl.exitTouchControl =
        function () {
    ...
    var Za = function (a, b, c, d) {
        ...
        var c = parseInt(a.substr(0, 2), 16), d = parseInt(a.substr(2, 2), 16), k = parseInt(a.substr(4, 2), 16);
        return Za(c, d, k, b)
    };
    ...
    this.OOP.drawArr = function (a, b) {
        var c, d;
        c = 0;
        for (d = a.length; c < d; c += 1) a[c].isInCamera && a[c].draw && a[c].isInCamera() && (a[c].draw(), b && b(a[c], c))
    };
    var Qb = function (a) {
        a.length = 0
    };
    this.OOP.readJSON = function (a, b) {
        ...
        d.onreadystatechange = function () {
            4 == d.readyState && (c = d.responseText, c =
                JSON.parse(c), B.load(), b(c))
        };
        d.send()
    };
    ...
    this.OOP.delObject = function (a, b) {
        var c, d;
        c = 0;
        for (d = a.length; c < d && a[c].id != b.id; c += 1) ;
    };
    ...
    this.OOP.includeSync = function (a, b) {
        if (J[a]) J[a].loaded && !b && J[a].code(); else {
            J[a] = {
    ...
    this.OOP.include = function (a, b, c) {
        if (J[a]) J[a].loaded && !c && J[a].code(), b && b(); else {
            J[a] = {
                loaded: !1, code: function () {
                    console.log(a + " is loading")
                }
    ...
    var ta = 60, K = Date.now(), $a = 0, ab = -1, Rb = K, fa = {};
    ...
    var Sb = function () {
        return h.requestAnimationFrame || h.webkitRequestAnimationFrame || h.mozRequestAnimationFrame ||
            h.oRequestAnimationFrame || h.msRequestAnimationFrame || function (a) {
    ...
    this.game.newLoopFromClassObject = function (a, b) {
        ...
        fa[a] = {func: b.update, start: b.entry || !1, end: b.exit || !1, audio: !1, fps: !1, name: a}
    };
    this.game.newLoopFromConstructor = function (a, b) {
        ...
        fa[a] = {
            func: c.update,
            start: c.entry || !1, end: c.exit || !1, audio: !1, fps: !1, name: a
        }
    };
    ...
    var tc = [], uc = 0, ma = !1, ga = function (a, b) {
    ...
    C.prototype = {
        getID: function () {
            ...
            var b, c;
            b = 0;
            for (c = this.children.length; b <
            c; b += 1) if (this.children[b].id == a.id) {
            ...
            var b, c;
            b = 0;
            for (c = a.length; b < c; b += 1) if (a[b].id != this.id && this.isIntersect(a[b])) return a[b];
            return !1
        }, isArrInside: function (a) {
            var b, c;
            b = 0;
            for (c = a.length; b < c; b += 1) if (this.isDynamicInside(a[b].getDynamicBox())) return a[b];
            return !1
        }, getNearest: function (a) {
            var b, c = 0, d = !1, k;
            b = 0;
            for (k = a.length; b < k; b += 1) if (this.id != a[b].id) {
            ...
            return 0 == this.angle ? [e(this.x + this.box.x, this.y + this.box.y), e(this.x + this.box.x + this.w + this.box.w, this.y + this.box.y), e(this.x + this.box.x + this.w + this.box.w, this.y + this.box.y + this.h + this.box.h), e(this.x + this.box.x, this.y + this.box.y + this.h + this.box.h)] : [M(e(this.x + this.box.x, this.y + this.box.y), a, this.getAngle()), M(e(this.x + this.box.x + this.w + this.box.w, this.y + this.box.y), a, this.getAngle()), M(e(this.x + this.box.x +
                this.w + this.box.w, this.y + this.box.y + this.h + this.box.h), a, this.getAngle()), M(e(this.x + this.box.x, this.y + this.box.y + this.h + this.box.h), a, this.getAngle())]
        }, isDynamicIntersect: function (a) {
            if (3 > a.length) return !1;
            var b = this.getDynamicBox(), c, d;
            c = 0;
            for (d = b.length; c < d; c += 1) if (ia(b[c], a)) return !0;
            c = 0;
            for (d = a.length; c < d; c += 1) if (ia(a[c], b)) return !0;
            return !1
            ...
            if (3 >
                a.length) return !1;
            var b = this.getDynamicBox(), c, d, k = 0;
            c = 0;
            ...
            g.shadowColor = "transparent";
            ua(e(this.x + this.box.x, this.y + this.box.y), A(this.w + this.box.w, this.h + this.box.h),
                !1, a || "yellow", 2);
            Yb(e(this.x + this.w / 2 + this.center.x, this.y + this.h / 2 + this.center.y), 10, a || "yellow")
            ...
            var a = this.getDynamicBox(), b =
                [e(f.x, f.y), e(f.x + r, f.y), e(f.x + r, f.y + t), e(f.x, f.y + t)], c, d, k = 0;
            c = 0;
            ...
            var b, c;
            b = 0;
            for (c = a.length; b < c; b += 1) if (this.id != a[b].id) this.onCollision(a[b])
        }, draw: function () {
        }
    };
    ...
    rb.prototype.draw = function () {
        if (this.visible && this.alpha) {
            ...
            if (this.angle || 1 != this.alpha || this.shadowColor) N(this), a = !0;
            sb(e(this.x, this.y),
                A(this.w, this.h), this.radius, this.fillColor, this.strokeColor, this.strokeWidth);
            if (this.ondraw) this.ondraw();
            a && L()
        }
    };
    ...
    tb.prototype.draw = function () {
        if (this.loaded) {
            ...
            for (d = 0; d < this.countY; d += 1) if (!(this.y + d * this.h + this.h < f.y || this.y + d * this.h > f.y + t)) for (c = 0; c < this.countX; c += 1) this.x + c * this.w + this.w < f.x || this.x + c * this.w > f.x + r || g.drawImage(this.cnv, a + c * this.w, b + d * this.h, this.w, this.h)
        }
    };
    ...
    X.prototype.reStyle = function (a) {
        ...
        this.w = vb(this.text, this.style,
            this.size, this.font) + 2 * this.padding;
        this.h = this.size + 2 * this.padding;
    ...
    pa.prototype.setImage = function (a, b) {
        this.file != a && (q(p[a]) ? (this.file = a, b && b()) : (this.loaded = !1, this.origHeight = this.origWidth = 0, this.forOnLoad =
            b || !1, $b(a, this)))
    };
    ...
    V.prototype.drawFrames = function (a, b, c) {
        if (this.visible && this.alpha) {
            ...
            c = !1;
            if (this.angle ||
                1 != this.alpha || this.flip.x || this.flip.y || this.shadowColor) N(this), c = !0;
            wb(this.anim, e(this.x, this.y), A(this.w, this.h), this.frame);
            if (this.ondraw) this.ondraw();
    ...
    V.prototype.drawReverFrames = function (a, b) {
        if (this.visible && this.alpha) {
            ...
            this.difStep > this.step ?
                (this.frame <= a ? this.toFrameStep = 1 : this.frame >= b && (this.toFrameStep = -1), this.frame = this.frame <= this.anim.r ? this.frame + this.toFrameStep : 0, this.difStep = 0) : this.difStep += 1
        }
    };
    ...
    var wa = function (a) {
        ...
        this.h = this.w =
            0;
        this.toLoad = [];
        var b = h.document.createElement("img"), c = this;
        b.onload = function () {
            c.loaded = !0;
            c.w = this.width;
            c.h = this.height;
        ...
        if (q(p[a])) {
            ...
            if (q(b)) {
                ...
                if (b.w && !b.h) {
                    ...
                    d = b.w;
                    k = p[a].h * e
                } else !b.w && b.h ? (e = b.h / p[a].h, k = b.h, d = p[a].w * e) : b.w && b.h ? (d = b.w, k = b.h) : (d = p[a].w, k =
                    p[a].h);
                c && (d *= c, k *= c);
                b.w = d;
                b.h = k;
    ...
    bc.prototype = {
        getCount: function () {
            ...
            if (this.x != a.x || this.y != a.y) {
                ...
                var b = this;
                x(this.objs, function (a) {
                    b.angle ? a.setPositionC(M(e(b.x + a.offsetMesh.x, b.y + a.offsetMesh.y),
                        e(b.x, b.y), b.angle)) : a.setPositionC(e(b.x + a.offsetMesh.x, b.y + a.offsetMesh.y))
                })
            }
        }, isDynamicIntersect: function (a) {
            if (3 > a.length) return !1;
    ...
    this.camera.getStaticBox = function () {
        return {x: f.x, y: f.y, w: f.x + r, h: f.y + t}
    };
    ...
    this.brush.drawPolygon = function (a) {
        var b = a.points || [], c = a.fillColor || !1, d = a.strokeColor || !1, k = a.strokeWidth || 1;
        a = a.pointColor || !1;
        if (!(3 > b.length)) {
            var e;
            if (c && !(3 > b.length)) {
                ...
                for (h = 1; h < b.length; h += 1) g.lineTo(c +
                    b[h].x, e + b[h].y);
                g.closePath();
                g.fill()
            }
    ...
    this.brush.drawMultiText = function (a) {
        ...
        for (b = 0; b < c.length; b += 1) oa(e(a.x, a.y + a.size * b), c[b], a.color || v.fillStyle, a.size || 10, a.font || v.font, a.style || !1, a.align ||
            "left", a.strokeColor || !1, a.strokeWidth || 2)
    };
    ...
    this.brush.drawTextS = function (a) {
        oa(e((a.x || 0) + f.x, (a.y ||
            0) + f.y), a.text, a.color || v.fillStyle, a.size || 10, a.font || v.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2)
    };
    ...
    this.brush.drawTextLinesS = function (a) {
        if (a.lines) {
            var b, c = a.size || 10;
            for (b = 0; b < a.lines.length; b += 1) oa(e(a.x + f.x, a.y + f.y + c * b), a.lines[b], a.color ||
                v.fillStyle, c, a.font || v.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2)
        }
    };
    ...
    this.brush.drawRoundRectS = function (a) {
        sb(e(f.x + a.x, f.y + a.y), A(a.w, a.h), a.radius || 2, a.fillColor || !1, a.strokeColor || v.strokeStyle, a.strokeWidth ||
            !1)
    };
    ...
    this.brush.drawLine = function (a) {
        Y(e(a.x1, a.y1), e(a.x1 +
            a.x2, a.y1 + a.y2), a.strokeColor || v.strokeStyle, a.strokeWidth || 1)
    };
    ...
    this.brush.drawImageS = function (a) {
        if (a.file) if (q(p[a.file])) {
            if (p[a.file].loaded) {
                var b = a.x || 0, c = a.y || 0, d, e;
                if (a.w && !a.h) {
        ...
        } else p[a.file] = {loaded: !1}, b = h.document.createElement("img"), b.onload = function () {
            p[a.file].loaded = !0;
            p[a.file].img = this;
    ...
    this.brush.onPixels = function (a, b, c, d, e) {
        ...
        for (k = c.data.length; d < k; d += 4) {
            var f = {r: c.data[d], g: c.data[d + 1], b: c.data[d + 2], a: c.data[d + 3] ? c.data[d + 3] : 255};
            e(f);
            c.data[d] = f.r;
            c.data[d + 1] = f.g;
            c.data[d + 2] = f.b;
    ...
    var ca = function (a, b) {
        ...
        if ("string" == typeof a) {
            ...
            f.src = a;
            e.appendChild(f)
        } else for (c = 0, d = a.length; c < d; c += 1) f = h.document.createElement("source"), f.src = a[c], e.appendChild(f);
        this.vol = b && 1 >= b && 0 < b ? b : 1;
        this.playing = 0;
        this.audio = e;
    ...
    ca.prototype.stop = function () {
        this.playing && (this.playing = !1, this.audio.pause(), this.audio.currentTime =
            0)
    };
    ...
    this.dialogs.openLine = function (a, b) {
        ...
        c.onkeydown = function (a) {
            a.stopPropagation();
            if (27 == a.keyCode || 13 == a.keyCode) a = c.value.trim(), "function" == typeof b && b("" != a ?
                a : !1), h.document.body.removeChild(c), u.game.resume()
        };
        n.attach(c);
        c.focus()
    };
    ...
    this.dialogs.openTouchLine = function (a, b, c) {
        ...
        e.style.backgroundColor = b.fillColor ||
            "white";
    ...
    this.levels.forStringArray = function (a) {
        ...
        x(a.source, function (c, d) {
            x(c, function (c, f) {
                if (" " != c) {
                    var k = a.onsymbol(c) || !1;
                    k && (k.setSize(a.size), a.grid ? k.setPosition(e(b.x + f * a.grid.w, b.y + d * a.grid.h)) :
                        k.setPosition(e(b.x + f * k.w, b.y + d * k.h)), a.oncreate(k, c))
                }
            })
        })
    };
    var cc = function (a) {
        ...
        this.getObjectByName = function (a) {
            ...
            b = 0;
            for (d = c.length; b <
            d; b += 1) if (c[b].name == a) return c[b];
            return !1
        };
        this.getObjectById = function (a) {
            var b, d;
            b = 0;
            for (d = c.length; b < d; b += 1) if (c[b].id == a) return c[b];
            return !1
        };
        this.draw = function () {
            x(c, function (a) {
